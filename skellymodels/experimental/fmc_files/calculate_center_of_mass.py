...
from skellymodels.experimental.model_v2 import Aspect
...
def calculate_center_of_mass_from_aspect(skeleton: Aspect) -> Tuple[np.ndarray, np.ndarray]:
    """
    ...
    """
    if skeleton.anatomical_structure.center_of_mass_definitions is None:
        raise ValueError("Segment center of mass definitions must be defined before calculating center of mass.")

    if skeleton.anatomical_structure.segment_connections is None:
